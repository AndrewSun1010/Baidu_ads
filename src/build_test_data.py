...
def to_idx_files(dataset_dir, test_txt, shard_size=200_000, maxlen=200):
    ...
    with open(os.path.join(dataset_dir, test_txt)) as f:
...
if __name__ == "__main__":
    to_idx_files(
        ...
        test_txt="test.txt", shard_size=200_000, maxlen=200
        )
